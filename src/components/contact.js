            ...
            <section className="commom-section contact-form-wrapper">
                <div className="container">
                    <div className="heading-section contact">
                        <h2>Get in Touch</h2>
                        <p>Although I'm not currently looking for freelance opportunities, my inbox is always open.I'm here to help or just to say hi, I'll try my best to answer your email!</p>
                    </div>
